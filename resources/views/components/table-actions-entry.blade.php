...
{{--view--}}
<button wire:click="$emit('onViewEntry', {{$id}})" wire:loading.attr="disabled" data-title="View" class="cursor-pointer inline-table items-center px-2 py-1 text-white bg-yellow-600 hover:bg-yellow-800 rounded">
