{{--view--}}
<button wire:click="$emit('onViewEntry', {{$id}})" wire:loading.attr="disabled" title="View" class="cursor-pointer inline-table items-center px-2 py-1 text-white bg-green-600 hover:bg-green-800 rounded">
