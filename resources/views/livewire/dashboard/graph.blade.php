<div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4">
    ...
    <div class="mx-auto p-0 border-0 mb-4">
        <div class="bg-gray-300 text-gray-600 py-3 px-6 font-bold rounded-t-lg">
            Project Wise Distribution Chart
        </div>

        <div class="p-6 bg-gray-200 rounded-b-lg text-gray-800">
