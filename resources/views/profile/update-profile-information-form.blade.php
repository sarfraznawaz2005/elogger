<x-jet-form-section submit="updateProfileInformation" class="bg-gray-200 p-5 rounded-lg">
    ...
    <x-slot name="actions">
        ...
        <x-jet-button wire:loading.attr="disabled" wire:target="photo" class="bg-green-700 ml-4 hover:bg-green-800">
            <x-icons.ok/> {{ __('Save') }}
        </x-jet-button>
    </x-slot>
